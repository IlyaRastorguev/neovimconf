...
vim.opt.sidescrolloff = 40 -- Makes sure there are always eight lines of context
...
vim.keymap.set("n", "<leader>kt", ":Telescope colorscheme<CR>")
vim.keymap.set("n", "<leader>e", ":Oil<CR>")
vim.keymap.set("n", "<leader>p", ":Telescope find_files<CR>")
vim.keymap.set("n", "<leader>o", ":Telescope jumplist<CR>")
